...
const QuantityButton = ({ id, quantity, addCartEvent, subCartEvent, removeCart }: QuantityButtonProps) => {
    const signBtnStyle = "duration-500 ease-in rounded-full shadow-md p-1 hover:bg-secondary hover:text-white/80";
    return (
        <div className="flex flex-col items-center text-white mx-auto ">
            ...
            <div className="">
                <button className="bg-danger px-2 py-1 rounded-2xl shadow-md duration-500 ease-in hover:bg-secondary
